...
export default function LandingPage({ onEnter }: { onEnter: () => void }) {
  ...
  const handleEnter = () => {
    if (password === 'sunflower_and_ramen_9998!_!') {
      onEnter();
    } else {
      setError(true);
      setPassword('');
        ...
        <div className="max-w-4xl w-full space-y-12 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <input
              ...
              className="w-64 bg-black/40 border border-cyan-500/30 p-3 text-white text-center rounded-lg focus:outline-none focus:border-cyan-400 transition-all"
            />
